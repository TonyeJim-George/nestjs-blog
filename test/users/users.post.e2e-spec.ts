...
import { bootstrapNestApplicationHelper } from '../helpers/bootstrap-nest-application.helper';
...
describe('[Users] @Post Endpoints', () => {
  ...
  beforeEach(async () => {
    // Instantiate the app
    app = await bootstrapNestApplicationHelper();
    // Get the config
  ...
  afterEach(async () => {
    await dropDatabaseHelper(config);
    await app.close();
  });
